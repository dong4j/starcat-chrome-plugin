...
Please report security issues through [GitHub Security Advisories](https://github.com/starcat-app/starcat-chrome-plugin/security/advisories/new) before opening a public issue.
